...
public class RecycleViewMainAdapter extends BaseQuickAdapter<OrderMainMode.MessageBean,BaseViewHolder> {

    private Context mCOntext;
    public RecycleViewMainAdapter(Context mCOntext,List<OrderMainMode.MessageBean> modeLists) {
...
//
    ...
    @Override
    protected void convert(BaseViewHolder helper, OrderMainMode.MessageBean item) {
