 ...
 * @version $Id: IOUtils.java 1091653 2011-04-13 05:22:45Z ggregory $
 */
public class IOUtils {
    ...
    static {
        ...
        ClosedInputStream.StringBuilderWriter buf = new ClosedInputStream.StringBuilderWriter(4);
    ...
    public static String toString(InputStream input, String encoding)
            throws IOException {
        ClosedInputStream.StringBuilderWriter sw = new ClosedInputStream.StringBuilderWriter();
